    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            if (msg.what == 1) {
                ...
                tv_test_result.setText(data_path + File.separator + test_result_dwt_path);
    ...
    private void doPredictionGSModel(int n) {
        executor.execute(new Runnable() {
            ...
            public void run() {
                ...
                for (int i = 0; i < n; i ++) {
                    String resultDTWJson = data_path + File.separator + test_result_dwt_gs_model_path + i;
                    costTime += mViewModel.doPredictGSModel(
                            tempfilePath, testfilePath, resultDTWJson, getContext()
                    );
                }
    ...
    private void doPredictionSVCModel(int n) {
        executor.execute(new Runnable() {
            ...
            public void run() {
                ...
                for (int i = 0; i < n; i ++) {
                    String resultDTWJson = data_path + File.separator + test_result_dwt_svc_model_path + i;
    ...
    private void doPredictionKNNModel(int n) {
        executor.execute(new Runnable() {
            ...
            public void run() {
                ...
                for (int i = 0; i < n; i ++) {
                    String resultDTWJson = data_path + File.separator + test_result_dwt_knn_model_path + i;
    ...
    private void doPredictionModel(int n) {
        executor.execute(new Runnable() {
            ...
            public void run() {
                ...
                for (int i = 0; i < n; i ++) {
                    String resultDTWJson = data_path + File.separator + test_result_dwt_model_path + i;
    ...
    private void doPredictionRfModel(int n) {
        executor.execute(new Runnable() {
            ...
            public void run() {
                ...
                for (int i = 0; i < n; i ++) {
                    String resultDTWJson = data_path + File.separator + test_result_dwt_rf_model_path + i;
    ...
    private void doPredictionDTW(int n) {
        executor.execute(new Runnable() {
            ...
            public void run() {
                ...
                for (int i = 0; i < n; i ++) {
                    String resultDTWJson = data_path + File.separator + test_result_dwt_fix_path + i;
                    costTime += mViewModel.doPredictionDTW(
                            tempfilePath, testfilePath, resultDTWJson
                    );
                }
    ...
    private void doPredictionOptimizeDTW(int n) {
        executor.execute(new Runnable() {
            ...
            public void run() {
                ...
                for (int i = 0; i < n; i ++) {
                    String resultDTWJson = data_path + File.separator + test_result_dwt_optimize_path + i;
    ...
    private void doPredictionNDDTW(int n) {
        executor.execute(new Runnable() {
            ...
            public void run() {
                ...
                for (int i = 0; i < n; i ++) {
                    String resultDTWJson = data_path + File.separator + test_result_dwt_nd_path + i;
    ...
    private void doPredictaion(int n) {
        executor.execute(new Runnable() {
            ...
            public void run() {
                ...
                costTime = 0;
                for (int i = 0; i < n; i ++) {
                    String resultDTWJson = data_path + File.separator + test_result_dwt_path + i;
                    mViewModel.initTempData(tempfilePath);
                    mViewModel.initTestData(testfilePath);
                    costTime += mViewModel.dodtw(resultDTWJson);
                }
